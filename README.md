...
`RUNWAY.md` is the pre-departure plan: what gets done from Madrid, week by week, and the landing week day by day. The rule is that Manila time is for filming, meeting people, and running tours, and nothing else.
